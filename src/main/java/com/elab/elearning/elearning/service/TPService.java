...
public class TPService {
    ...
    private final Path root = Paths.get("TP");
    ...
    public List<FileDB> getAllTPs(Module module){

        return fileRepository.findAll().stream().filter(fileDB ->
                fileDB.getDocumentType() == DocumentType.TP && fileDB.getModule() == module).collect(Collectors.toList());
    }
